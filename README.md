...
Ok for the second auto scaling stress test, I decided to just overwhelm the CPUs themself.  
It's a more realistic simulation of what happens in production when an app is under heavy load, especially since the WAF will help with the request handling, this is a more likely situation where the auto scaling will trigger.  
<br>
